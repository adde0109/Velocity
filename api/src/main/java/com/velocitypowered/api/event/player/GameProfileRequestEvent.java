...
public final class GameProfileRequestEvent {
  ...
  private final @Nullable SecurityProfile originalChatSecurityProfile;
  private @Nullable SecurityProfile chatSecurityProfile;
   ...
   * @param originalChatSecurityProfile security profile of the player for 1.19+
   */
  public GameProfileRequestEvent(InboundConnection connection, GameProfile originalProfile,
      boolean onlineMode, @Nullable SecurityProfile originalChatSecurityProfile) {
    ...
    this.originalChatSecurityProfile = originalChatSecurityProfile;
  }
  ...
  public SecurityProfile getOriginalChatSecurityProfile() {
    return originalChatSecurityProfile;
  }

  public SecurityProfile getChatSecurityProfile() {
    return chatSecurityProfile == null ? originalChatSecurityProfile : chatSecurityProfile;
  }

  public void setChatSecurityProfile(SecurityProfile chatSecurityProfile) {
