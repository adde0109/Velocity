...
public class ArgumentPropertyRegistry {
  ...
  static {
    ...
    register(id("minecraft:resource_or_tag", mapSet(MINECRAFT_1_19, 45)),
            RegistryKeyArgument.class, RegistryKeyArgumentSerializer.REGISTRY);
    ...
    register(id("minecraft:uuid", mapSet(MINECRAFT_1_19, 43)), StringArgumentType.class, STRING); // added in 1.16
